...
const AddSubSubCategory = () => {
    ...
    const handleSubmit = async (event) => {
        ...
        formData.append('subcategory_id', selectedOption);
        formData.append('name_en', ename);
        formData.append('name_ch', aname);
        formData.append('name_ru', cname);
        
        try {
          const response = await fetch('https://api.sdcbm.com/api/store/subsubcateg', {
            method: 'POST',
            body: formData,
            headers: {
 ...
 <div className="add-sub-sub-category">
